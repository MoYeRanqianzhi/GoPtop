...
import { BoardPanel, loadDefaults, PeerList, RtcStatusLine, StunSettings } from "./pages/components";
...
/* ---------------- 主应用 ----------------
 * 本文件只保留三件事：对局状态机（board/toMove/winner…）、信令编排
 * （createInvite/acceptInvite/acceptReceipt…）、路由与页面拼装。
 * 可复用组件在 pages/components.tsx，本地对战页在 pages/LocalPage.tsx，
 * 棋盘规则在 game/board.ts（D1 拆分）。 */
