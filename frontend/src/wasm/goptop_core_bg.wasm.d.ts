...
export const wasmgame_adopt: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => number;
export const wasmgame_boardSize: (a: number) => number;
